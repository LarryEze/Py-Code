...
# Save as a PNG file
fig.savefig("Introduction to Data Visualization with Matplotlib\\my_figure.png")
...
fig.savefig(
    "Introduction to Data Visualization with Matplotlib\\my_figure_300dpi.png", dpi=300)
...
plt.show()
fig.savefig("Introduction to Data Visualization with Matplotlib\\figure_3_5.png")
...
fig.savefig(
    "Introduction to Data Visualization with Matplotlib\\sports_weights.png")
